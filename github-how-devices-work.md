...
1. Lithium plating on anode (especially with fast charging)
2. SEI (Solid Electrolyte Interphase) layer thickens over cycles
3. Cathode crystal structure degrades from repeated lithium insertion/extraction
...
- [TechPulse @techpulse.league](https://instagram.com/techpulse.league)
- [JEDEC DRAM Standards](https://www.jedec.org/)
- [IEEE 802.11 WiFi Specification](https://standards.ieee.org/)
